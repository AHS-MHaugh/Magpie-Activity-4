...
public class MagpieActivity4{
	...
	{
        //getResponse accessor method determines a response based upon a keyword.
	...
	private int findKeyword(String statement, String goal,
			int startPos)
                //^This is the findKeyword constructor.^
	{
	...
	{    
/**
* getRandomResponse accessor method is used to provide
* a response to inputs with no keyword.
*/
